...
public class TerrainImporter : MonoBehaviour
{
    ...
    #region Preset Maps
    private void LoadMap(int cols, int rows, System.Func<IEnumerator> more)
    {
        _terrainInfo.InitWalls(cols, rows);
        StartCoroutine(more());
    }
    ...
    private IEnumerator LoadMap02More()
    {
        ...
        _terrainInfo.SetWall(14, 7);
        _terrainInfo.SetWall(15, 7);
        _terrainInfo.SetWall(16, 7);
        _terrainInfo.SetWall(14, 8);
        _terrainInfo.SetWall(16, 8);
        _terrainInfo.SetWall(14, 9);
        _terrainInfo.SetWall(16, 9);
